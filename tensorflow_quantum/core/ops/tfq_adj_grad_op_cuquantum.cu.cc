...
class TfqAdjointGradientGpuOp : public tensorflow::OpKernel {
 public:
  explicit TfqAdjointGradientGpuOp(tensorflow::OpKernelConstruction* context)
      : OpKernel(context) {}
...
REGISTER_KERNEL_BUILDER(
    Name("TfqAdjointGradientGpu").Device(tensorflow::DEVICE_CPU),
    TfqAdjointGradientGpuOp);

REGISTER_OP("TfqAdjointGradientGpu")
